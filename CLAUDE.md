...
- **On hardware** (the owner, 2026-09-24): works on a **Raspberry Pi** and on the **console** (the owner's PSC,
  nightly launcher 811b296). The **PC stick** is untested because the PC stick itself is not debugged yet.
